...
public enum OnboardingStepType: Int, CaseIterable, Identifiable, Codable {
...
public struct NextStep: Codable, Equatable, Identifiable {
    ...
    // CodingKeys to exclude id from Codable
    private enum CodingKeys: String, CodingKey {
        case title, description, actionType, priority, iconName, estimatedTime, isOptional
    }
